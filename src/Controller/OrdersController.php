...
class OrdersController extends AbstractController
{
    ...
    #[Route('orders/new', name: 'app_orders_new', methods: ['GET', 'POST'])]
    ...
    #[Route('orders/{idorder}', name: 'app_orders_show', methods: ['GET'])]
    ...
    #[Route('orders/{idorder}/edit', name: 'app_orders_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('orders/{idorder}', name: 'app_orders_delete', methods: ['POST'])]
